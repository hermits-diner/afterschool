...
export default function PrintAttendance() {
  ...
  return (
    <div className="min-h-full bg-slate-100 py-8 print:bg-white print:py-0">
      {/* Force landscape for the attendance grid */}
      ...
      <div className="no-print mx-auto mb-4 flex max-w-5xl items-center justify-between px-4">
        ...
        <div className="text-sm text-slate-500">출석부 미리보기 · 가로 방향 인쇄 권장</div>
        <button className="btn-primary" onClick={() => window.print()}>
          <Icons.printer size={16} /> 인쇄하기
        </button>
      </div>

      <div className="print-sheet mx-auto max-w-5xl rounded-xl bg-white p-8 shadow-card print:max-w-none print:rounded-none print:p-0 print:shadow-none">
        <div className="mb-1 text-center text-sm text-slate-500">2026학년도 1학기 방과후학교</div>
        <h1 className="mb-4 text-center text-2xl font-bold text-slate-900">출석부</h1>
